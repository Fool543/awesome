...
globalkeys = gears.table.join(
	...
	end, { description = "launch a powermenu", group = "applications" }),
	...
	-- Volume
	--awful.key({}, "XF86AudioRaiseVolume", function () awful.util.spawn("pamixer -i 4", false) end),
	--awful.key({}, "XF86AudioLowerVolume", function () awful.util.spawn("pamixer -d 4", false) end),
	...
	awful.key({ modkey }, "p", function()
		menubar.show({ show_categories = "false" })
...
awful.rules.rules = {
	...
	--{ rule_any = { class = { "copyq"}, properties = { placement = awful.placement.no_offscreen } },
...
--run_once({
--	"trayer --edge top --widthtype pixel --width 100 --height 20 --iconspacing 3 --align right --distancefrom right --distance 265 --tint 0x222222 --transparent false --padding 4 --SetDockType true --SetPartialStrut true --alpha 115",
--})
--run_once("/home/ard/.config/awesome/import-gsettings.sh")
